...
def consult(sum,limit,bmi): 
    ...
    if sum > limit:
        if bmi >= 18.5 and bmi < 24 and sum > limit:
            return 'วันนี้คุณรับประทานอาหารเกินปริมาณแคลอรี่ที่ต้องการต่อวันแล้ว (แต่ถ้าหากว่าคุณต้องการลดน้ำหนัก คุณควรรับประทานให้อยู่ในช่วง {:.1f} Kcal - {:.1f} Kcal'.format(limit-250,limit)
        else:

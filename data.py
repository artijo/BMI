...
AD = {
    "rec":{'de':'วันนี้คุณได้รับปริมาณพลังงานอยู่ในช่วงที่เหมาะสมต่อร่างกายแล้ว'
    },
    "rec2":{'de':'วันนี้คุณรับประทานอาหารต่ำกว่ากำหนด(1200 Kcal) ถ้าหากคุณต้องการเพิ่มน้ำหนักควรรับประทานอาหารให้อยู่ในช่วงแคลอรี่ของคุณและต้องมากกว่า 500 Kcal'
    },
    "rec3":{'de':'วันนี้คุณรับประทานอาหารเกินปริมาณแคลอรี่ที่ต้องการต่อวันแล้ว (แต่ถ้าหากว่าคุณต้องการลดน้ำหนัก คุณควรรับประทานให้น้อยกว่า 1200 Kcal)'
    }
}
